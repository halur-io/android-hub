...
- **`models/`**: Domain model package with 17 modules covering user, site, menu, branch, order, stock, receipt, print, ops, dine-in, marketing, sms, catering, checklist, content, payment, and audit.
